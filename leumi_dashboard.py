...
print(os.path.exists("/Users/aviluvchik/Python Projects/Leumi/assets/oporto_logo.png"))
print(os.path.exists("/Users/aviluvchik/Python Projects/Leumi/assets/leumi_logo.png"))

# --- Paths for logos ---
script_dir = os.path.dirname(__file__)  # Directory of the script
oporto_logo_path = os.path.join(script_dir, "assets/oporto_logo.png")
leumi_logo_path = os.path.join(script_dir, "assets/leumi_logo.png")

# --- Debug prints to verify relative paths ---
print(os.path.exists(oporto_logo_path))
print(os.path.exists(leumi_logo_path))
...
# ================== 2) PORTFOLIO CARBON ANALYSIS ==================
    ...
    tasks = pd.DataFrame({
        ...
        "Owner": [
            "Finance", "HR", "IT Department", "Sustainability Team", "Operations", "Sustainability Team", "Finance",
    ...
    try:
        ...
        st.plotly_chart(reduction_chart)
    except IndexError:
...
# ================= 3) COMPLIANCE & REGULATORY =================
    ...
    selected_task = st.selectbox("Select a Task to Analyze:", task_tracker["Task"])
